...
class NotificationListRepository {
  ...
  Future<AcceptOrderResponseModel> fetchClearAllNotificationData(dynamic data) async {
    try {
      dynamic response = await _apiServices.getPostApiResponse(
          AppUrl.clearAllNotificationUrl, data);
      print('================ orderlist 11111111==============$response');
      print('================url data======${AppUrl.clearAllNotificationUrl}========$data');
      print('==============2222222================${NotificationResModel
          .fromJson(response)}');
