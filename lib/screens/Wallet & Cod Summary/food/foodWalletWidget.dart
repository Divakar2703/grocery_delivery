...
class FoodWalletWidgets extends StatefulWidget {
  const FoodWalletWidgets({super.key});

  @override
  State<FoodWalletWidgets> createState() => _FoodWalletWidgetsState();
}

class _FoodWalletWidgetsState extends State<FoodWalletWidgets> {
