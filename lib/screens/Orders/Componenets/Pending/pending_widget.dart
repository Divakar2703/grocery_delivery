...
class _PendingWidgetState extends State<PendingWidget> {
  ...
  @override
  void initState() {
    final orderListRequestModel = OrderListRequestModel(
      userId: "OrderListViewModel",
    );
    orderListViewModel.fetchOrderListData(
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ChangeNotifierProvider<OrderListViewModel>(
        ...
        child: Consumer<OrderListViewModel>(builder: (context, value, _) {
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: Colors.grey,
                                    // You can change this color to the desired border color
                                    width:
                                        1.0, // You can adjust the border width as needed
                                  ),
                                ),
                                child: Padding(
